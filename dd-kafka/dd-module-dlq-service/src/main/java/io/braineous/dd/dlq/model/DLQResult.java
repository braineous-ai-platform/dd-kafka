package io.braineous.dd.dlq.model;
...
public class DLQResult {
    ...
    public DLQResult(JsonObject ddEventJson,
                     String endpoint,
                     Integer httpStatus,
                     Long durationMs,
                     boolean ok,
    ...
    public static DLQResult ok(JsonObject ddEventJson,
                               String endpoint,
                               Integer httpStatus,
                               Long durationMs) {
        return new DLQResult(ddEventJson, endpoint, httpStatus, durationMs, true, null);
    }

    public static DLQResult fail(JsonObject ddEventJson,
                                 String endpoint,
                                 Integer httpStatus,
                                 Long durationMs,
                                 Why why) {
        return new DLQResult(ddEventJson, endpoint, httpStatus, durationMs, false, why);
    }

    public static DLQResult fail(String endpoint,
                                 Integer httpStatus,
                                 Long durationMs,
                                 Why why) {
        return new DLQResult(null, endpoint, httpStatus, durationMs, false, why);
    }
